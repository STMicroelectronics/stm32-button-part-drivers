...
# Release Notes for <mark>Button Part Drivers</mark> SW Pack
...
More detailed documentation is available at [Button Part Drivers online documentation]( https://dev.st.com/stm32cube-docs/part-driver-button/latest/en/index.html ).
...
First official release of Button Part Drivers.
